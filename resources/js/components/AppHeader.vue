...
import { Crown, GraduationCap, Home, Medal, Newspaper } from 'lucide-vue-next';
    ...
    >
        ...
        >
            ...
            <div v-if="user" class="flex items-center gap-2">
                <!-- Points Badge -->
                <div
                    class="hidden items-center gap-2 rounded-full border border-secondary/30 bg-secondary/20 px-3 py-1.5 sm:flex"
                >
                ...
                <DropdownMenu>
                    <DropdownMenuTrigger as-child>
                        ...
                        >
                            <Avatar
                                class="h-10 w-10 border-2 border-primary/20"
                            >
                                <AvatarImage
                                    v-if="user.avatar"
                                    :src="user.avatar"
        ...
        <div class="border-t bg-background md:hidden">
            <nav class="flex items-center justify-around px-2 py-2">
                <Link
                    ...
                    :key="link.href"
                    :href="link.href"
                    class="flex min-w-[60px] flex-col items-center gap-1 rounded-md px-3 py-2 text-xs font-medium transition-colors"
                    :class="[
                        isActive(link.href)
                            ? 'text-primary'
