        ...
        <CardHeader>
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-2">
                    <select
                        v-model="currentView"
                        class="w-24 rounded-md border border-gray-300 bg-white px-3 py-2 text-sm"
                    >
            ...
            <div class="space-y-4">
                ...
                <div v-if="currentView === 'week'" class="space-y-2">
                    ...
                    <div class="grid grid-cols-7 gap-1">
                        <div
                            v-for="header in (calendarGrid as any).headers"
                            :key="header"
                        ...
                        <div
                            v-for="day in (calendarGrid as any).days"
                            :key="day.date"
                            class="flex aspect-square items-center justify-center rounded border text-sm"
                            :class="[
                ...
                <div v-else class="space-y-4">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        <div
                            v-for="month in (calendarGrid as any).months"
                            :key="month.month"
                            class="space-y-2"
                        >
                ...
                >
                    ...
                    <div class="flex gap-1">
                        <div
                            class="h-3 w-3 rounded bg-gray-100 dark:bg-gray-800"
                        ></div>
                        <div
                            class="h-3 w-3 rounded bg-green-200 dark:bg-green-900"
                        ></div>
                        <div
                            class="h-3 w-3 rounded bg-green-300 dark:bg-green-800"
                        ></div>
                        <div
                            class="h-3 w-3 rounded bg-green-400 dark:bg-green-700"
                        ></div>
                        <div
