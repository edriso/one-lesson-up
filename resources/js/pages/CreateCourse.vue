    ...
    modules: [
        {
            ...
            name: '',
            description: '',
            lessons: [{ id: crypto.randomUUID(), name: '', description: '' }],
        },
    ] as Module[],
});
...
const addCustomTag = (tagName: string) => {
    if (
        tagName.trim() &&
        form.tags.length < 3 &&
        !form.tags.includes(tagName.trim())
    ) {
...
const getAddButtonText = () => {
    ...
    const isExistingTag = props.available_tags?.some(
        (tag) =>
            tag.name.toLowerCase() ===
            customTagInput.value.toLowerCase().trim(),
    );
        ...
        <div class="mx-auto max-w-4xl space-y-6">
            ...
            <div>
                ...
                <p class="text-muted-foreground">
                    Build your learning path with modules and lessons. Once
                    created, classes cannot be edited.
                </p>
            </div>
                ...
                <CardContent class="p-4">
                    <div class="flex gap-3">
                        ...
                        <div class="space-y-1">
                            ...
                            >
                                <li>
                                    Classes cannot be edited or deleted after
                                    creation
                                </li>
                                <li>
                                ...
                                <li>
                                    <strong>Learning deadline:</strong> Complete
                                    your class within the calculated deadline to
                                    earn bonus points (maintain at least 5
                                    lessons per week pace)
                                </li>
                                <li>
                                    This simulates a 5-day work week learning
                                    schedule with 2 rest days
                                </li>
                                <li>
                                    After the deadline, you can still complete
                                    the class but won't receive bonus points
                                </li>
                                <li>
                                    You will be automatically enrolled in your
                                    class
                                </li>
                            </ul>
                        </div>
                    ...
                    <CardContent class="space-y-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <p class="text-sm text-muted-foreground">
                                Add a link to class materials, syllabus, or
                                resources
                            </p>
                            <p
                        ...
                        <div class="space-y-2">
                            <div class="flex items-center justify-between">
                                <div class="space-y-0.5">
                                    <Label for="is_public"
                                        >Make Class Public</Label
                                    >
                                    <p class="text-sm text-muted-foreground">
                                        Allow other users to discover and join
                                        this class
                                    </p>
                                </div>
                                <Switch
                ...
                <Card>
                    ...
                    <CardContent class="space-y-4">
                        ...
                        <div v-if="form.tags.length > 0" class="space-y-2">
                            <Label
                                >Selected Tags ({{ form.tags.length }}/3)</Label
                            >
                            ...
                            <div class="relative">
                                ...
                                >
                                    ...
                                    <div
                                        ...
                                        :key="tag.id"
                                        class="cursor-pointer border-b border-border px-3 py-2 text-sm last:border-b-0 hover:bg-muted"
                                ...
                                <div
                                    ...
                                    "
                                    class="absolute top-full right-0 left-0 z-50 mt-1 rounded-md border border-border bg-background p-3 shadow-lg"
                                >
                                    <p class="text-sm text-muted-foreground">
                                        <span class="font-medium"
                                            >"{{ customTagInput }}"</span
                                        >
                                        will be created as a new tag
                                    </p>
                                </div>
                            </div>
                            ...
                            <CardHeader>
                                ...
                                >
                                    <div class="flex flex-1 items-start gap-3">
                                        <GripVertical
                                            class="mt-2 h-5 w-5 text-muted-foreground"
                                        />
                                        <div class="flex-1 space-y-4">
                                            ...
                                            <div class="space-y-2">
                                                <Label
                                                    :for="`module-${module.id}-description`"
                            ...
                            <CardContent class="space-y-3">
                                ...
                                <div class="space-y-3 pl-8">
                                    ...
                                    <div
                                        ...
                                        :key="lesson.id"
                                        class="flex gap-3 rounded-lg bg-muted/30 p-3"
                                    >
                    ...
                    <CardContent class="p-6">
                        ...
                        >
                            <div>
                                ...
                                <p class="text-sm text-muted-foreground">
                                    Review your modules and lessons before
                                    submitting. Classes cannot be edited or
            ...
            <Button
                @click="goToTop"
                class="fixed right-6 bottom-6 z-50 h-12 w-12 rounded-full bg-primary text-primary-foreground shadow-lg hover:bg-primary/90"
                size="sm"
            >
